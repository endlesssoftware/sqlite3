...
.IFDEF __VAX__
CC = GCC
CFLAGS = $(CFLAGS)/OPT=2/SCAN=$(ETCDIR)CONFIG.H/LIST=$(ETCDIR).LIS/MACHINE
...
$(BINDIR)SQLITE3.EXE : $(ETCDIR)CONFIG.H,-
    ...
    $(LINK)/EXE=$(MMS$TARGET)/MAP=$(ETCDIR)/CROSS/FULL-
...
$(BINDIR)SQLITE3_SHR.EXE : $(ETCDIR)CONFIG.H,-
    ...
    $(LINK)/SHARE=$(MMS$TARGET)/NOTRACEBACK/MAP=$(ETCDIR)/CROSS/FULL-
...
$(SRCDIR)SQLITE3_ALIASES.S	: $(SRCDIR)SQLITE3_VECTOR.MAR
    @ CONTINUE
...
$(SRCDIR)SQLITE3_VECTOR.MAR	: $(BINDIR)SQLITE3.OLB($(OBJECTS))
	...
	"$(SRCDIR)SYMBOL_VECTOR.TXT=$(ETCDIR)SQLITE3.LIS $(MMS$TARGET),$(SRCDIR)SQLITE3_ALIASES.S"

!
! Alpha/I64-specific transfer vector construction
!
$(SRCDIR)SQLITE3_VECTOR$(OPT)	: $(BINDIR)SQLITE3.OLB($(OBJECTS))
    $(LIBR)/LIST=$(ETCDIR)SQLITE3.LIS/NAMES $(BINDIR)SQLITE3.OLB/OBJECT
    $(MUNG) MAKE_SYMBOL_VECTOR.TEC -
